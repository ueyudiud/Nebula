...
/**
 * The Nebula extended base type of fluid.
 * @author ueyudiud
 */
public class FluidBase extends Fluid
{
	...
	{
		this(fluidName, localName, new ResourceLocation(G.activeModid(), "fluids/" + fluidName),
				new ResourceLocation(G.activeModid(), "fluids/" + fluidName + "_flowing"));
	}
	...
	{
		return LanguageManager.translateLocal(getTranslateName(stack));
	}
