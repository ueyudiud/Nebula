...
public class Network extends MessageToMessageCodec<FMLProxyPacket, IPacket>
{
	...
	private boolean needToSend(IPacket packet)
	{
		...
		{
			NebulaLog.error("The packet {} does not exist in packet list! The packet " + "sending will be canceled, please report this bug to mod creator.", packet.getClass().getCanonicalName());
			return false;
		}
