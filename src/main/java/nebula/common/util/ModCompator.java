...
public class ModCompator
{
	...
	public void addCompatible(String modid, String location)
	{
		if (G.isModLoaded(modid))
		{
			...
			{
				NebulaLog.error("Fail to put '{}' into compatibles map, this compatibility will be removed.", exception, location);
			}
		}
	}
	...
	public final void call(String phase)
	{
		...
		{
			NebulaLog.info("The compatible from {} to {} start to invoke with phase {}.", this.modid, entry.getKey(), phase);
			try
			{
			...
			{
				NebulaLog.warn("Fail to make compatible with {} and {} mod.", exception, this.modid, entry.getKey());
			}
		}
	}
