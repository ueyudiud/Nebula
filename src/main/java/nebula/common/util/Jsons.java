...
public final class Jsons
{
	...
	public static <E> List<E> getAsList(JsonArray array, ObjIntFunction<JsonElement, E> function)
	{
		List<E> list = new ArrayList<>();
