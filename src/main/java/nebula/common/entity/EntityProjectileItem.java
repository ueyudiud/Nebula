...
public class EntityProjectileItem extends Entity implements IThrowableEntity, IProjectile, IDescribable
{
	...
	{
		Direction direction = W.getCollideSide(aabb, new double[] { this.posX, this.posY, this.posZ }, new double[] { this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ });
		if (direction == null)
		{
