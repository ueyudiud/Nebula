...
import nebula.common.tile.ITilePropertiesAndBehavior.*;
...
public abstract class BlockSingleTE extends BlockBase implements ITileEntityProvider
{
	...
	public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn)
	{
		...
		TileEntity tile = W.getTileEntity(worldIn, pos, false);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
	{
		...
		{
			((ITB_BlockPlacedBy) tile).onBlockPlacedBy(state, placer, Direction.of(placer.getHorizontalFacing()), stack);
		}
	}
	...
	{
		return W.setBlock(world, pos,
				getStateForPlacement(world, pos, facing, hitX, hitY, hitZ, this.item.getMetadata(stack), placer, stack),
				createTileEntity(world, pos, stack, placer), 3);
	}
	
	protected  TileEntity createTileEntity(World world, BlockPos pos, ItemStack stack, EntityPlayer placer)
	{
		return createNewTileEntity(world, this.item.getMetadata(stack));
	}
}
