...
public class UnlocalizedList
{
	...
	{
		this.list.add(LanguageManager.translateLocal(arg, translation));
	}
	
	public void addPost(String arg, Object...translation)
	{
		this.postList.add(LanguageManager.translateLocal(arg, translation));
	}
	
	public void addNotNull(String arg, Object...translation)
	{
		String val = LanguageManager.translateLocalWithIgnoreUnmapping(arg, translation);
		if (val != null)
		{
			this.list.add(val);
		}
	...
	public void addToolTip(String arg)
	{
		String val;
		int i = 1;
		while ((val = LanguageManager.translateLocalWithIgnoreUnmapping(arg + '.' + i++)) != null)
		{
			this.postList.add(val);
		}
	}
