...
public class Renders
{
	...
	{
		((ClientProxy) NebulaProxy.proxy).registerColorMultiplier(color, block);
	}
	
	public static void registerBiomeColorMultiplier(Block...block)
	{
		((ClientProxy) NebulaProxy.proxy).registerBiomeColorMultiplier(block);
	}
	
	public static void registerColorMultiplier(IItemColor color, Item...item)
	{
		((ClientProxy) NebulaProxy.proxy).registerColorMultiplier(color, item);
	}
