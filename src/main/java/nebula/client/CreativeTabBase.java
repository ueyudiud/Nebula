...
public class CreativeTabBase extends CreativeTabs implements IRenderRegister
{
	...
	{
		return LanguageManager.translateLocal(super.getTranslatedTabLabel());
	}
	...
	public final ItemStack getIconItemStack()
	{
		if (this.stack == null)
		{
			this.stack = this.appliable.applyOptional().map(ItemStacks.COPY_ITEMSTACK).orElse(new ItemStack(Blocks.FIRE));
		}
