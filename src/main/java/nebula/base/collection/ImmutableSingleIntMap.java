...
class ImmutableSingleIntMap<E> extends ImmutableIntMap<E>
{
	...
	@Override
	public void forEach(Consumer<? super IntEntry<E>> action)
	{
		action.accept(new IntEntry_<>(this.key, this.value));
	}
	...
	{
		return Iterators.forArray(new IntEntry_<>(this.key, this.value));
	}
}
