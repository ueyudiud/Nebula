...
public class ArrayIntMap<E> extends AbstractIntMap<E>
{
		...
		return new Iterator<IntEntry<E>>()
		{
			...
			public IntEntry<E> next()
			{
				while (ArrayIntMap.this.keys[this.pos] == null)
					this.pos ++;
				this.count ++;
				IntEntry<E> entry = new IntEntry_(ArrayIntMap.this.keys[this.pos], ArrayIntMap.this.values[this.pos]);
				this.pos ++;
				return entry;
			}
	...
	@Override
	public int computeIfAbsent(E key, ToIntFunction<? super E> function)
	{
