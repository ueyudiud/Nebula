 ...
 * @author ueyudiud
 */
@Mod(modid = "ed", name = "Extra Data", version = "0.3", dependencies = "required-after:nebula")
public class ED
{
	@Instance("ed")
	...
	public static void trace(String msg, Object...format)
	{
		logger.trace(msg, format);
	}
	...
	public void load(FMLPreInitializationEvent event)
	{
		...
		metadata.description =
				"The Extra Data mod provided extra block data from only " +
